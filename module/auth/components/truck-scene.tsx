      ...
      >
        <defs>
          <linearGradient id="sky" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="oklch(0.72 0.13 259.8)" />
            <stop offset="100%" stopColor="oklch(0.58 0.18 259.8)" />
          </linearGradient>
        </defs>
        ...
        <g>
          ...
          <rect
            ...
            height="26"
            rx="8"
            fill="oklch(0.4 0.16 259.8)"
          />
          <g fill="oklch(0.623 0.188 259.81)" opacity="0.9">
        ...
        <g className="animate-[truckDrive_7s_ease-in-out_infinite]">
          ...
          <rect
            ...
            fill="oklch(0.4 0.16 259.8)"
          />
          <g fill="oklch(0.4 0.16 259.8)">
            <rect x="30" y="222" width="46" height="10" rx="3" opacity="0.35" />
          </g>
          <g>
            <circle cx="44" cy="262" r="10" fill="oklch(0.24 0.05 258)" />
            <circle cx="44" cy="262" r="4" fill="white" />
            <circle cx="112" cy="262" r="10" fill="oklch(0.24 0.05 258)" />
