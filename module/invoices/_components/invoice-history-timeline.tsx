...
import { useSalesInvoiceHistoryQuery } from "../hooks";
...
const ACTION_LABEL: Record<string, string> = {
  ...
  return_issued: "ترحيل مرتجع",
  cancelled: "إلغاء",
};

export function InvoiceHistoryTimeline({ invoiceId }: { invoiceId: number }) {
  const { data, isLoading, isError } = useSalesInvoiceHistoryQuery(invoiceId);
